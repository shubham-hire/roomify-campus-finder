  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Every room is personally verified by our team. No fake listings, no scams.",
    },
    {
      icon: MapPin,
      title: "Near Your College",
      description:
        "Find rooms within walking distance of your campus. Save time and money.",
    },
    {
      icon: UserCheck,
      title: "No Brokers. No Hassle.",
      description:
        "Connect directly with verified landlords. Zero brokerage fees.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="font-inter text-lg md:text-xl text-white/90 mb-8">
              Discover verified rooms, hostels, and PGs around your campus in
              seconds.
          ...
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="font-inter text-muted-foreground">
                Handpicked verified accommodations near top colleges
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-muted-foreground max-w-2xl mx-auto">
              We're building the most trusted platform for student housing in
              India
            </p>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-muted-foreground">
              Join thousands of happy students who found their perfect room
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-card rounded-2xl p-8 shadow-card">
                ...
                <p className="font-inter text-foreground mb-6 italic">
                  "{testimonial.text}"
                </p>
                <div>
      ...
      <section className="py-16 md:py-24 bg-gradient-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="font-inter text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            List your room for free and connect with verified students. No
            commission fees for the first 3 months!
          </p>
          <Button
            size="lg"
            variant="secondary"
